...
- 3/19/2024 Updated how Litigation Hold Status comment was being posted. Now it is a single comment instead of part of general comment. Also Updated GetADEmployeeDetails. Correctly checking Displayname and Given Name for variations of the name.
